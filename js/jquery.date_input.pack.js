DateInput = (function($) {
	...
	DateInput.prototype = {
		...
		insideSelector: function(event) {
			...
			return event.pageY -81 < offset.bottom && event.pageY -81> offset.top && event.pageX -62 < offset.right && event.pageX -62 > offset.left
		},
		...
		setPosition: function() {
			...
			this.rootLayers.css({
				top: offset.top + this.input.outerHeight()-80 ,
